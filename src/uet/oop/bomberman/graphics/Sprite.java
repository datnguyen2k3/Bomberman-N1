...
public class Sprite {
	...
	// CAT
	public static Sprite cat_right1 = new Sprite(DEFAULT_SIZE, 5, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite cat_right2 = new Sprite(DEFAULT_SIZE, 5, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite cat_right3 = new Sprite(DEFAULT_SIZE, 5, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite cat_left1 = new Sprite(DEFAULT_SIZE, 4, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite cat_left2 = new Sprite(DEFAULT_SIZE, 4, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite cat_left3 = new Sprite(DEFAULT_SIZE, 4, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite cat_dead = new Sprite(DEFAULT_SIZE, 4, 8, SpriteSheet.tiles, 16, 16);
	...
	public static Sprite red_coin_left = new Sprite(DEFAULT_SIZE, 13, 6, SpriteSheet.tiles, 16, 16);

	public static Sprite orange_coin_right = new Sprite(DEFAULT_SIZE, 14, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite orange_coin_left = new Sprite(DEFAULT_SIZE, 15, 6, SpriteSheet.tiles, 16, 16);

	// segment
	public static Sprite red_segment = new Sprite(DEFAULT_SIZE, 12, 7, SpriteSheet.tiles, 16, 16);
	public static Sprite orange_segment = new Sprite(DEFAULT_SIZE, 14, 7, SpriteSheet.tiles, 16, 16);
